...
pub(crate) static CONFIG_REGISTRY: &[ConfigEntry] = &[
    ...
    ConfigEntry {
        key: ConfigKey::MaxInFlightPerDept,
        name: "max_in_flight_per_dept",
        env_key: "FKST_MAX_IN_FLIGHT_PER_DEPT",
        kind: ConfigKind::Operational { default: "16" },
        value_type: ConfigValueType::Usize,
        doc: "Steady-state ceiling for concurrent durable Department children.",
    },
    ConfigEntry {
        key: ConfigKey::DurableAdmissionBurstPerDept,
        name: "durable_admission_burst_per_dept",
        env_key: "FKST_DURABLE_ADMISSION_BURST_PER_DEPT",
