...
fn check_sdk_registration(host_root: &std::path::Path) -> Result<()> {
    ...
    lua.load(
        ...
        expect_type("declare_intent", declare_intent, "function")
        expect_type("wait_until_intent_visible", wait_until_intent_visible, "function")
        expect_type("perform_or_recover_effect", perform_or_recover_effect, "function")
        expect_type("write_result_marker", write_result_marker, "function")
        expect_type("wait_until_result_visible", wait_until_result_visible, "function")
        expect_type("derive_next_transition_from_visible_result", derive_next_transition_from_visible_result, "function")
